#include "list_op_menu.h"
#include <QDesktopServices>
#include <QUrl>

List_Op_Menu::List_Op_Menu(QWidget *widget) :
    QMenu(widget)
{
    Create_Actions_keven();
    translateActions();
}
List_Op_Menu::~List_Op_Menu()
{

}
void List_Op_Menu::Create_Actions_keven()
{
    //创建菜单项
...
void List_Op_Menu::translateActions()
{
